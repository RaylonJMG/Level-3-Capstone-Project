...
export function Home() {
	...
	return (
		<main id="homeMain">
			...
			<br />
			<p>
				Visit our Sesame Street Location and try all that the Good Food Hut has
				to offer. We have been sharing our Good Food Philosophy for over 20
				years and you haven't seen nor tasted anything yet!
			</p>
			<hr />
			<img
				src={Interior}
