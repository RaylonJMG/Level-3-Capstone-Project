...
Submit Rating
	...
	/>
				...
				<p>
					We offer cateringservices for events of any size!
...
<br />	<input required name="firstName" type="text"
id="firstName"
...
<br />
<input required name="email" type="text" id="email" placeholder="Enter Email Address"
/>
<br />
...
<br />
<input type="submit" value="Submit" id="mixin-button" />
<input type="reset" value="Reset form" id="mixin-button" />
</form> */}
