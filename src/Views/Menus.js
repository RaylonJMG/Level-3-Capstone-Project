			...
			<body class="m-4 p-4">
				<header>
					...
					<nav class="nav nav-fill nav-pills">
						...
						<a class="nav-link active" aria-current="page" href="menus.html">
							MENU
						</a>
				...
				<footer class="text-center border border-5 border-dashed border-primary">
					<b>Menu Map</b>
					<br />
					<nav>
					...
					<br /> Good Food Hut❃12345 Big Bird Ave, Sesame Street, LA 12345❃
					337-555-4321❃
					<br />
